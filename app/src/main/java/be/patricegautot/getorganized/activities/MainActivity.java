...
import be.patricegautot.getorganized.DaysFragmentPagerAdapter;
...
import be.patricegautot.getorganized.utilities.Keys;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(initMobileAds){
            initMobileAds = false;
            MobileAds.initialize(this, Keys.ADMOB_KEY);
